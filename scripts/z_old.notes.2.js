...
$.fn.Notes = function(controls)
{
    ...
    (function(self) {
        if(controls){
            ...
            _background = (chrome && chrome.extension && chrome.extension.getBackgroundPage)? chrome.extension.getBackgroundPage() : main; /*_background = main;*/
    ...
    function loadNotes() {
        ...
        _background.loadNotes(function(notes){
            console.log('loaded')
            initNotes(notes);
    ...
    function replaceNotes(first, second){
        ...
        for(var i = min; i <=  max; i++){
            ...
            _background.saveNote(_notes[i], "DisplayOrder");
        }
    }
    ...
    function createNote(title){
        ...
        _background.addNote(_notes[_notes.length-1], function(insertId){
    ...
    function saveTitle(title){
        ...
        _background.saveNote(_notes[_edit.note.index], "Title");
    ...
    function deleteNote() {
        ...
        _background.removeNote(_notes[index].ID);
    ...
    function onNoteChanged(e){
        ...
        _background.saveNote(note, "Description");
    }
